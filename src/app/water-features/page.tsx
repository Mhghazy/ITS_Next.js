...
export default function WaterFeatures() {
  return (
    <main className="flex min-h-screen flex-col pt-[48px] lg:pt-[96px]">
      {/* Hero Section with Wave Shape Divider */}
      <section className="relative w-full h-[60vh] md:h-[70vh] min-h-[400px] flex flex-col justify-center items-center bg-black overflow-hidden">
        {/* Background Image */}
        <div className="absolute inset-0 z-0">
          <img 
            src={getAssetUrl("/assets/images/services/water-features-bg.jpg")}
            alt="Water Feature Background"
        ...
        <div className="relative z-10 text-center px-4 w-full">
          <motion.h1 
            className="text-white font-bold text-5xl md:text-7xl capitalize tracking-wider drop-shadow-lg"
        ...
        {/* Bottom Wave-Brush Shape Divider */}
        <div className="absolute bottom-0 left-0 w-full overflow-hidden leading-none z-20">
          <svg 
            xmlns="http://www.w3.org/2000/svg" 
            viewBox="0 0 283.5 27.8" 
            preserveAspectRatio="none"
            className="relative block w-[100%] h-[40px] md:h-[70px] fill-white"
          >
      ...
      {/* Main Content Area */}
      <section className="py-24 px-6 bg-white min-h-[500px]">
         <div className="max-w-7xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold text-[var(--color-primary)] mb-6">Our Water Features</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Transform your space into a serene aquatic paradise with our premium swimming pool designs tailored to your architectural vision.
            </p>
         </div>
      </section>
    </main>
